# Generated by Django 5.2.11 on 2026-02-22 15:30
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("patient", "Patient / Pregnant Woman"),
                            ("doctor", "Doctor"),
                            ("fchv", "FCHV Worker"),
                            ("admin", "Admin"),
                        ],
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Marks if the user has completed the onboarding flow.",
                    ),
                ),
                (
                    "date_joined",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "profile_picture",
                    models.ImageField(
                        blank=True, null=True, upload_to="profiles/fchv/"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "profile_picture",
                    models.ImageField(
                        blank=True, null=True, upload_to="profiles/patients/"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
